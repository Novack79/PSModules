...
Function Get-AllPublicDNSRecords
{
<#
...
#>
    ...
    $listDNS = Get-PublicDnsRecord -DomainName $DomainName -DnsRecordType @('A','AAAA','CERT','CNAME','DHCIP','DLV','DNAME','DNSKEY','DS','HINFO','HIP','IPSECKEY','KX','LOC','MX','NAPTR','NS','NSEC','NSEC3','NSEC3PARAM','OPT','PTR','RRSIG','SOA','SPF','SRV','SSHFP','TA','TALINK','TLSA','TXT')

    return $listDNS
}

Export-ModuleMember -Function Get-PublicDNSRecord
Export-ModuleMember -Function Get-AllPublicDNSRecords